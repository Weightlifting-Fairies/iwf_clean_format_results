...
#path = '/home/cjw/Documents/iwf_data_clean/iwf_results/new_bw_2019_csv/'
path = '/home/cjw/Documents/iwf_data_clean/iwf_results/'
...
def read():
    ...
    for root,dirs,files in os.walk(directory):
        ...
        for file in files:
            #file = path + file
            #file = '/home/cjw/Documents/iwf_data_clean/iwf_results/new_bw_2019_csv/' + file
            file = '/home/cjw/Documents/iwf_data_clean/iwf_results/old_bw_2018_csv/' + file
...
def output(r):
    """Output the data"""
    #outfile = open("cleaned_new_bw_2019.csv", "w")
