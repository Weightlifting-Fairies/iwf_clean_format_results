...
# This is for one result csv only

path = '/home/cjw/Documents/iwf_data_clean/Results.csv'
...
def read():
    ...
    l = []
    for line in lines[1:]:
        row = line.translate({ord(c): None for c in '"=-'}
                             )  # deletes ", =, and -
...
def output(r):
    """Output the data"""
    outfile = open("cleaned_results2019.csv", "w")
